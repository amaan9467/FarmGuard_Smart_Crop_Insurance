        ...
        <div className="w-full md:w-1/2 md:pl-12 text-center md:text-left">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-4 mt-8">
            <button
              ...
              className="bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-full text-lg font-semibold shadow-md hover:shadow-green-300/40 transform hover:-translate-y-1 transition duration-300 ease-in-out"
            >
              Learn More
            </button>
            <button
              onClick={() => navigate("/contacts")}
              className="border-2 border-green-600 text-green-700 px-8 py-3 rounded-full text-lg font-semibold hover:bg-green-600 hover:text-white shadow-md hover:shadow-green-300/40 transform hover:-translate-y-1 transition duration-300 ease-in-out"
            >
              Join Initiative
            </button>
          </div>

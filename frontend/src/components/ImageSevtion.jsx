...
const ImageSection = () => {
  ...
  {/* 🌾 Get Started Button — opens login */}
  <button
    onClick={() => {
    ...
    className="bg-yellow-500 hover:bg-yellow-600 text-green-900 font-semibold px-8 py-3 rounded-full text-lg shadow-lg hover:shadow-yellow-300/50 transform hover:-translate-y-1 transition duration-300 ease-in-out"
  >
    Get Started
  </button>

  {/* 🌿 Read More Button — goes to About page */}
  <button
    onClick={() => navigate("/about")}
    className="bg-white border-2 border-gray-300 rounded-full text-green-900 font-semibold px-8 py-3 text-lg shadow-md hover:shadow-yellow-300/40 hover:border-yellow-400 transform hover:-translate-y-1 transition duration-300 ease-in-out"
  >
    Read More
  </button>
</div>

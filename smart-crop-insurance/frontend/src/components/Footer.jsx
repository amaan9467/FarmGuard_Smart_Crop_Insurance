...
const footerData = {
  ...
  footerBottom: {
    ...
    credit: "Designed with 🌿 by Amaan and Team",
  },
};

// 🌾 Icon Mapping
const iconMap = { Facebook, Twitter, Instagram, Mail, Phone, MapPin };
              ...
              {footerData.brand.socials?.map((social) => {
                ...
                return (
                  <a
                    key={social.name}
                    href={social.url}
                    className="p-2 bg-yellow-400/20 rounded-full hover:bg-yellow-400/40 transition"
                  >
                    <Icon size={18} />
                  </a>
                );

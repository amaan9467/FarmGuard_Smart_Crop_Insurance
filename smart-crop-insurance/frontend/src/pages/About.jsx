  ...
  <div className="max-w-2xl items-center justify-center px-6 mx-auto grid md:grid-cols-1 gap-10">
    ...
    <div className="bg-white rounded-2xl items-center justify-center shadow-lg hover:shadow-2xl transition-all duration-300 p-8 text-center border border-green-200 hover:border-green-500">
      <div className="relative flex justify-center">
        ...
        />
        <span className="absolute bottom-0 right-1 bg-green-600 text-white text-xs px-2 py-0.5 rounded-full">
          Founder
        </span>
      </div>
      ...
      {/* Social Icons */}
      <div className="flex justify-center gap-4 mt-4 text-green-700 text-lg">
        <i className="fa-brands fa-linkedin hover:text-green-900 cursor-pointer"></i>
        <i className="fa-brands fa-instagram hover:text-green-900 cursor-pointer"></i>
        <i className="fa-brands fa-facebook hover:text-green-900 cursor-pointer"></i>
      </div>
    </div>
